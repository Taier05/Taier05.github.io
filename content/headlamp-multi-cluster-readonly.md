...
kind: Config
clusters:
- name: example-new-test
  cluster:
    server: https://<example-new-test-apiserver>:6443
    certificate-authority-data: <base64-ca>

- name: example-aliyun
  cluster:
    server: https://<example-aliyun-apiserver>:6443
    certificate-authority-data: <base64-ca>

users:
- name: example-new-test-headlamp
  user:
    token: <KUBERNETES_SERVICE_ACCOUNT_TOKEN>

- name: example-aliyun-headlamp
  user:
    token: <KUBERNETES_SERVICE_ACCOUNT_TOKEN>
...
- name: example-new-test
  context:
    cluster: example-new-test
    user: example-new-test-headlamp

- name: example-aliyun
  context:
    cluster: example-aliyun
    user: example-aliyun-headlamp

current-context: example-new-test
```
...
kubectl -n nginx-gateway get gateway example-gw
